...
import { Building2, Eye, EyeOff, Moon, Sun, Check, ArrowLeft } from 'lucide-react';
...
const benefits = [
  'Manage unlimited properties & tenants',
  'Automated agreement expiry alerts',
      ...
      <div className="hidden lg:flex w-1/2 bg-primary/5 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          ...
          <p className="text-muted-foreground mb-8">
            Join thousands of brokers who have simplified their property management workflow with RoomBroker.
          </p>
          ...
          <div className="mt-12 p-6 rounded-2xl bg-card border border-border">
            <div className="flex items-center gap-4 mb-3">
              ...
              <div>
                <div className="font-semibold text-foreground">Rahul Khanna</div>
                <div className="text-sm text-muted-foreground">Property Broker, Pune</div>
              </div>
            </div>
            <p className="text-muted-foreground italic">
              "I was skeptical at first, but RoomBroker paid for itself in the first month. The time I save on paperwork is incredible."
            </p>
          </div>
        </div>
      </div>
              ...
              {step === 1 ? (
                ...
                <>
                  <div className="p-4 rounded-lg bg-muted/50 border border-border">
                    <div className="text-sm text-muted-foreground">Creating account for</div>
                    <div className="font-semibold text-foreground">{formData.email}</div>
                  </div>
